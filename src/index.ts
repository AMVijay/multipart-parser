...
export class MultipartParser {
    ...
    public parse(multipartContentBuffer: Buffer, boundary: string): MultipartContent[] {
        ...
        for (let i = 0; i < multipartContentBuffer.length; i++) {
            let byteContent = multipartContentBuffer[i];
